 ...
 * to complete the remaining methods. There is a completed version of the game
 * included in this project, Minesweeper.jar, for you to test out (right click -> run).
 *
 * Background:
